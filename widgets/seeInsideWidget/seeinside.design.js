function twxSeeInside() {
  return {
    ...
    runtimeTemplate: function (props, twxWidgetEl, fullOriginalDoc, $, projectSettings) {
      ...
      var shaders= forholo ? vs0 + ps0 + vs1+ ps1 + ps2 +vs2 + vs3 + ps3 : vs1 + ps1 + vs3 + ps3;
      return shaders + ctrl;
